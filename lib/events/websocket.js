  ...
  module.exports = function(app) {
    ...
    linda.io.sockets.on("connection", function(socket) {
      ...
      return socket.on("disconnect", function(data) {
        var i, name, _i, _len, _ref3, _ref4, _ref5;
        console.log('disconnect!');
        username = (_ref3 = socket.handshake) != null ? (_ref4 = _ref3.session) != null ? (_ref5 = _ref4.passport) != null ? _ref5.user.username : void 0 : void 0 : void 0;
        console.log(username);
        if (username) {
