(function() {
  var BBObject, BabascriptManager, Crypto, DeviceModel, Group, GroupModel, Linda, LindaSocketIO, LocalStrategy, ObjectModel, TupleSpace, User, UserModel, express, mongoose, passport, _,
  ...
  BabascriptManager = (function() {
    ...
    BabascriptManager.prototype.attach = function(io, server, app) {
      ...
      this.app.put('/api/user/:name', (function(_this) {
        return function(req, res, next) {
          var data, param, password, username;
      ...
      this.app["delete"]('/api/user/:name', function(req, res, next) {
        ...
        console.log("delete");
        return this.getUser(username, function(err, user) {
          console.log(err);
