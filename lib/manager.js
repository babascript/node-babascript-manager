(function() {
  var BBObject, BabascriptManager, Crypto, DeviceModel, Group, GroupModel, Linda, LindaSocketIO, LocalStrategy, ObjectModel, TupleSpace, User, UserModel, async, express, mongoose, passport, _,
  ...
  BabascriptManager = (function() {
    ...
    BabascriptManager.prototype.attach = function(io, app) {
      ...
      return this.app.del('/api/group/:name/owner', (function(_this) {
        return function(req, res, next) {
          var attr;
          if (req.session.passport.user == null) {
            return res.send(404, "not logined");
